...
class TestAns(unittest.TestCase):
    ...
    def test_ans2(self):
        ...
        self.assertTrue(abs(answer - 11/4) < 0.0000001)
    ...
    def test_ans4(self):
        ...
        self.assertTrue(abs(answer - 365/96) < 0.0000001)
    ...
    def test_ans5(self):
        ...
        self.assertTrue(abs(answer - 8/3) < 0.0000001)

    def test_ans6(self):
        answer = generateAnswer('19 ÷ (8 × 5) + 2 = ')
        self.assertTrue(abs(answer - 99/40) < 0.0000001)
'''
